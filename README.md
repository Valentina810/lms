...
| email     | Обязательное, не пустое, не более 250 символов, должно соответствовать фоормату  Email | 400        | {<br/>"status": "BAD_REQUEST",  <br/>"message": "Email должен быть не больше 250 знаков; ",  <br/>"date": "2023-09-11 19:06:04"<br/>}         |
