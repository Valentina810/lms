...
VALUES ((SELECT users.id_user FROM users WHERE users.login='Vasilii'),
        ...
        '2023-08-29', '10:00:00', '10:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
       ...
       ((SELECT users.id_user FROM users WHERE users.login='Vasilii'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Математика'),
        '2023-09-01', '11:20:00', '12:00:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Vasilii'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Математика'),
        '2023-09-02', '12:00:00', '12:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Vasilii'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Математика'),
        '2023-09-03', '09:00:00', '09:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Vasilii'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Математика'),
        '2023-09-04', '11:20:00', '09:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Vasilii'),
       ...
       ((SELECT users.id_user FROM users WHERE users.login='Vasilii'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Информатика'),
        '2023-09-02', '11:20:00', '12:00:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Vasilii'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Информатика'),
        '2023-09-03', '10:20:00', '10:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Olga'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Информатика'),
        '2023-09-01', '10:20:00', '11:00:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Olga'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Информатика'),
        '2023-09-02', '10:20:00', '11:00:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Olga'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Информатика'),
        '2023-09-03', '10:00:00', '10:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Olga'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Русский язык'),
        '2023-09-01', '16:00:00', '16:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Olga'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Английский язык'),
        '2023-09-02', '09:00:00', '09:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Olga'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Литературное чтение'),
        '2023-09-02', '10:00:00', '10:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false),
       ((SELECT users.id_user FROM users WHERE users.login='Olga'),
        (SELECT subjects.id_subject FROM subjects WHERE subjects.name='Математика'),
        '2023-09-02', '11:00:00', '11:40:00', 'https://habr.com/ru/articles/560336/theory_url.htm',
        'https://habr.com/ru/practice_url.htm', 'https://habr.com/homework_url.htm', 0,
        false);