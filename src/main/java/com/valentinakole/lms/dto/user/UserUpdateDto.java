...
import static com.valentinakole.lms.util.validate.ValidationMessage.NOT_SPACES_VALUE;
...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Сущность 'Пользователь' (редактирование)")
public class UserUpdateDto {
    ...
    @Pattern(message = "Поле 'Логин'" + NOT_SPACES_VALUE, regexp = "^(?![\\s\\S]*\\s)[\\s\\S]+$")
